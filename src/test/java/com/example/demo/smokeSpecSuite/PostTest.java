...
import com.example.demo.client.JsonPlaceholderPostWebClient;
...
public class PostTest extends BaseTest {
    ...
    @Autowired
    private JsonPlaceholderPostWebClient postClient;

    @Test
    private void testGetAllPosts() {
        List<Post> allPosts = postClient.getAllPosts();
    ...
    void testGetPostById() {
        Post response = postClient.getPost(1);
    ...
    private void testCreateNewPost(){
        ...
        Post response = postClient.createPost(newPostElement);
